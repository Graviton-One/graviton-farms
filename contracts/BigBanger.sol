...
contract BigBanger is Ownable {
    ...
    // The SUSHI TOKEN!
    RelictGtonToken public relictGtonToken;
    // Dev address.
    ...
    constructor(
        RelictGtonToken _relictGtonToken,
        address _devaddr,
    ...
    function updatePool(uint256 _pid) public {
        ...
        relictGtonToken.mint(devaddr, relictReward.div(10));
        relictGtonToken.mint(address(this), relictReward);
